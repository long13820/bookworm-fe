 ...
 render() {
    ...
    <div className="container">
        ...
        >
            ...
            return (
                <SwiperSlide key={book.id} className="carousel">
                    <div className="card">
        ...
        <div className="book-list">
            ...
            <div id="mainRow" className="row">
                ...
                return (
                <div className="col-lg-3 col-md-4 col-sm-6 mb-4 align-items-stretch" key={book}>
                    <div className="card">
                        <img className="card-img-top img-fluid" src={book.book} alt="Books" />
                        <div className="card-body">
